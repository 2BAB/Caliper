...
@CaliperMeta(
        metadataInJSON = "{\"proxiedMethods\":[{\"className\":\"android/provider/Settings$Secure\",\"methodName\":\"getString\",\"opcode\":184,\"replacedClassName\":\"me/xx2bab/caliper/runtime/wrapper/ProxyWrittenInJavaForMethodProxy_CaliperWrapper\",\"replacedMethodName\":\"getString\"}],\"proxiedFields\":[],\"proxiedClasses\":[]}"
)
