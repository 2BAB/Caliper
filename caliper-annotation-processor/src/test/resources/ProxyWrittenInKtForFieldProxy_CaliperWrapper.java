...
@CaliperMeta(
        metadataInJSON = "{\"proxiedMethods\":[],\"proxiedFields\":[{\"className\":\"android/provider/Settings$Secure\",\"fieldName\":\"SERIAL\",\"opcode\":178,\"replacedClassName\":\"me/xx2bab/caliper/runtime/wrapper/ProxyWrittenInKtForFieldProxy_CaliperWrapper\",\"replacedMethodName\":\"getString\"}],\"proxiedClasses\":[]}"
)
